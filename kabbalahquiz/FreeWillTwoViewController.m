...
#import "FreeWillTwoViewController.h"
#import "Quiz.h"
#import "UIFont+QuiziOSAdditions.h"

@interface FreeWillTwoViewController ()
@property (weak, nonatomic) IBOutlet UIButton *infoButton;
@property (assign, nonatomic) NSInteger answer;

@end

@implementation FreeWillTwoViewController{
...
- (void)viewDidLoad
{
    ...
    self.quizIndex = 10;
    self.quiz = [[Quiz alloc] initWithQuiz:@"fw2"];
    ...
    //Tracking
    [[LocalyticsSession shared] tagEvent:@"Free Will - Part 2"];
