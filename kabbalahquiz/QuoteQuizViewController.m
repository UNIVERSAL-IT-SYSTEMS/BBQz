...
- (void)viewDidLoad
{
    ...
    //Tracking
    [[LocalyticsSession shared] tagEvent:@"Intro to Kabbalah"];
...
- (void)answerLabels
{
    ...
    answer1Label.font = [UIFont quizInterfaceFontOfSize:15.0f];
    ...
    answer2Label.font = [UIFont quizInterfaceFontOfSize:15.0f];
    ...
    answer3Label.font = [UIFont quizInterfaceFontOfSize:15.0f];
    ...
    answer4Label.font = [UIFont quizInterfaceFontOfSize:15.0f];
...
#pragma mark - Question visibility
...
-(void)checkAnswer {
    ...
    {
        self.quiz.total += 1;
        UIAlertView *rightAlertView  = [[UIAlertView alloc]initWithTitle:@"That's Right!" message: nil delegate:self cancelButtonTitle:@"Next" otherButtonTitles: nil];
        NSLog(@"Alert created");
        [rightAlertView show];
    ...
    {
        UIAlertView *wrongAlertView = [[UIAlertView alloc]initWithTitle:@"Bummer! Incorrect Answer" message:nil delegate:self cancelButtonTitle:@"Next" otherButtonTitles: nil];
        NSLog(@"Alert created");
        [wrongAlertView show];
