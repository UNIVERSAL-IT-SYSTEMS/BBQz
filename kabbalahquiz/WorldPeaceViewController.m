...
#import "WorldPeaceViewController.h"
#import "Quiz.h"
#import "UIFont+QuiziOSAdditions.h"

@interface WorldPeaceViewController ()
...
@implementation WorldPeaceViewController{
...
- (void)viewDidLoad
{
    ...
    self.quizIndex = 10;
    self.quiz = [[Quiz alloc] initWithQuiz:@"world"];
    ...
    //Tracking
    [[LocalyticsSession shared] tagEvent:@"World Peace"];
